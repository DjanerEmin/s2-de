...
Another alternative is to use `raster::getData`. This function et geographic data for anywhere in the world. Data are read from files that are first downloaded if necessary.

```{r}
DE <- st_as_sf(raster::getData("GADM", level = 1, country = "DE"))
plot(DE)
